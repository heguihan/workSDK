...
static NSString *hex_encode_data(NSData *data){
...
+ (NSString *)encryptString:(NSString *)str{
	NSData *data = [RSA encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] publicKey:[self HTPublicKey]];
	NSString *ret = hex_encode_data(data);
	return ret;
}
...
+(NSString*)HTPublicKey
{
    NSString *pubkey = @"-----BEGIN PUBLIC KEY-----\nMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC1jDlsT3SgLrjYVuxegFJlygU8\nhN0CqxHZI2c6Tn9/VmlmSugAtkm9u/VIm7/EjUhreQ6sGr5MyZXF68cH38Say7Oa\nb7ws2oHbaE2LfetwAXBC/THVH1l59HacLJiOnHFvBGKjPEQULyx4N5Gj9qAYbWeY\nsWFrt5f4g0bd4c+mKQIDAQAB\n-----END PUBLIC KEY-----";
    return pubkey;
}
